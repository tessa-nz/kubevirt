...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DiscardHibernationOptions) DeepCopyInto(out *DiscardHibernationOptions) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.DryRun != nil {
		in, out := &in.DryRun, &out.DryRun
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiscardHibernationOptions.
func (in *DiscardHibernationOptions) DeepCopy() *DiscardHibernationOptions {
	if in == nil {
		return nil
	}
	out := new(DiscardHibernationOptions)
	in.DeepCopyInto(out)
	return out
}
