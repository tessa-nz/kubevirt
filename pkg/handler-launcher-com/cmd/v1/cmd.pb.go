...
type HibernationAction int32

const (
	HibernationAction_HIBERNATION_ACTION_UNSPECIFIED    HibernationAction = 0
	HibernationAction_HIBERNATION_ACTION_SAVE           HibernationAction = 1
	HibernationAction_HIBERNATION_ACTION_RESTORE_PAUSED HibernationAction = 2
	HibernationAction_HIBERNATION_ACTION_COMMIT_UNPAUSE HibernationAction = 3
	HibernationAction_HIBERNATION_ACTION_ERASE          HibernationAction = 4
)

var HibernationAction_name = map[int32]string{
	0: "HIBERNATION_ACTION_UNSPECIFIED",
	1: "HIBERNATION_ACTION_SAVE",
	2: "HIBERNATION_ACTION_RESTORE_PAUSED",
	3: "HIBERNATION_ACTION_COMMIT_UNPAUSE",
	4: "HIBERNATION_ACTION_ERASE",
}
var HibernationAction_value = map[string]int32{
	"HIBERNATION_ACTION_UNSPECIFIED":    0,
	"HIBERNATION_ACTION_SAVE":           1,
	"HIBERNATION_ACTION_RESTORE_PAUSED": 2,
	"HIBERNATION_ACTION_COMMIT_UNPAUSE": 3,
	"HIBERNATION_ACTION_ERASE":          4,
}

func (x HibernationAction) String() string {
	return proto.EnumName(HibernationAction_name, int32(x))
}
func (HibernationAction) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }

type HibernationRequest struct {
	Vmi                 *VMI                   `protobuf:"bytes,1,opt,name=vmi" json:"vmi,omitempty"`
	Action              HibernationAction      `protobuf:"varint,2,opt,name=action,enum=kubevirt.cmd.v1.HibernationAction" json:"action,omitempty"`
	StatePath           string                 `protobuf:"bytes,3,opt,name=statePath" json:"statePath,omitempty"`
	AllowKernelMismatch bool                   `protobuf:"varint,4,opt,name=allowKernelMismatch" json:"allowKernelMismatch,omitempty"`
	Protection          *HibernationProtection `protobuf:"bytes,5,opt,name=protection" json:"protection,omitempty"`
}

func (m *HibernationRequest) Reset()                    { *m = HibernationRequest{} }
func (m HibernationRequest) String() string { return "HibernationRequest [private fields redacted]" }
func (*HibernationRequest) ProtoMessage()               {}
func (*HibernationRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }

func (m *HibernationRequest) GetVmi() *VMI {
	if m != nil {
		return m.Vmi
	}
	return nil
...
func (m *HibernationRequest) GetAction() HibernationAction {
	if m != nil {
		return m.Action
	}
	return HibernationAction_HIBERNATION_ACTION_UNSPECIFIED
}

func (m *HibernationRequest) GetStatePath() string {
	if m != nil {
		return m.StatePath
	}
	return ""
...
func (m *HibernationRequest) GetAllowKernelMismatch() bool {
	if m != nil {
		return m.AllowKernelMismatch
	}
	return false
}

func (m *HibernationRequest) GetProtection() *HibernationProtection {
	if m != nil {
		return m.Protection
	}
	return nil
...
// Private identity is carried only over the node-local handler/launcher RPC.
// Generated diagnostic formatters are redacted by hack/gen-proto.sh.
type HibernationProtection struct {
	...
	PrivateIdentity           []byte `protobuf:"bytes,4,opt,name=privateIdentity,proto3" json:"privateIdentity,omitempty"`
	ConsumptionCommitted      bool   `protobuf:"varint,5,opt,name=consumptionCommitted" json:"consumptionCommitted,omitempty"`
	FreshConsumption          bool   `protobuf:"varint,6,opt,name=freshConsumption" json:"freshConsumption,omitempty"`
	KeyErased                 bool   `protobuf:"varint,7,opt,name=keyErased" json:"keyErased,omitempty"`
	ProviderID                string `protobuf:"bytes,8,opt,name=providerID" json:"providerID,omitempty"`
	PrincipalID               string `protobuf:"bytes,9,opt,name=principalID" json:"principalID,omitempty"`
	RegistrationUID           string `protobuf:"bytes,10,opt,name=registrationUID" json:"registrationUID,omitempty"`
	ClusterID                 string `protobuf:"bytes,11,opt,name=clusterID" json:"clusterID,omitempty"`
	QualificationSourceKernel string `protobuf:"bytes,12,opt,name=qualificationSourceKernel" json:"qualificationSourceKernel,omitempty"`
	QualificationTargetKernel string `protobuf:"bytes,13,opt,name=qualificationTargetKernel" json:"qualificationTargetKernel,omitempty"`
	QualificationNodeUID      string `protobuf:"bytes,14,opt,name=qualificationNodeUID" json:"qualificationNodeUID,omitempty"`
	QualificationVMUID        string `protobuf:"bytes,15,opt,name=qualificationVMUID" json:"qualificationVMUID,omitempty"`
}

func (m *HibernationProtection) Reset()                    { *m = HibernationProtection{} }
func (m HibernationProtection) String() string { return "HibernationProtection [private fields redacted]" }
func (*HibernationProtection) ProtoMessage()               {}
func (*HibernationProtection) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }

func (m *HibernationProtection) GetProvider() string {
	if m != nil {
		return m.Provider
	}
	return ""
...
func (m *HibernationProtection) GetKeyID() string {
	if m != nil {
		return m.KeyID
	}
	return ""
...
func (m *HibernationProtection) GetRecipient() string {
	if m != nil {
		return m.Recipient
	}
	return ""
...
func (m *HibernationProtection) GetPrivateIdentity() []byte {
	if m != nil {
...
func (m *HibernationProtection) GetConsumptionCommitted() bool {
	if m != nil {
		return m.ConsumptionCommitted
	}
	return false
}

func (m *HibernationProtection) GetFreshConsumption() bool {
	if m != nil {
		return m.FreshConsumption
	}
	return false
}

func (m *HibernationProtection) GetKeyErased() bool {
	if m != nil {
		return m.KeyErased
	}
	return false
...
func (m *HibernationProtection) GetProviderID() string {
	if m != nil {
		return m.ProviderID
	}
	return ""
...
func (m *HibernationProtection) GetPrincipalID() string {
	if m != nil {
...
func (m *HibernationProtection) GetRegistrationUID() string {
	if m != nil {
		return m.RegistrationUID
	}
	return ""
}

func (m *HibernationProtection) GetClusterID() string {
	if m != nil {
		return m.ClusterID
	}
	return ""
...
func (m *HibernationProtection) GetQualificationSourceKernel() string {
	if m != nil {
		return m.QualificationSourceKernel
	}
	return ""
}

func (m *HibernationProtection) GetQualificationTargetKernel() string {
	if m != nil {
		return m.QualificationTargetKernel
	}
	return ""
}

func (m *HibernationProtection) GetQualificationNodeUID() string {
	if m != nil {
		return m.QualificationNodeUID
	}
	return ""
}

func (m *HibernationProtection) GetQualificationVMUID() string {
	if m != nil {
		return m.QualificationVMUID
	}
	return ""
}

type HibernationResponse struct {
	Response     *Response `protobuf:"bytes,1,opt,name=response" json:"response,omitempty"`
	Phase        string    `protobuf:"bytes,2,opt,name=phase" json:"phase,omitempty"`
	MetadataJson []byte    `protobuf:"bytes,3,opt,name=metadataJson,proto3" json:"metadataJson,omitempty"`
}

func (m *HibernationResponse) Reset()                    { *m = HibernationResponse{} }
func (m *HibernationResponse) String() string            { return proto.CompactTextString(m) }
func (*HibernationResponse) ProtoMessage()               {}
func (*HibernationResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }

func (m *HibernationResponse) GetResponse() *Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (m *HibernationResponse) GetPhase() string {
	if m != nil {
		return m.Phase
	}
	return ""
...
func (m *HibernationResponse) GetMetadataJson() []byte {
	if m != nil {
...
func (*QemuVersionResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*VMI) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*CPU) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*Sibling) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*Pages) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*Topology) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*SMBios) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*DiskInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*ClusterConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
func (*InterfaceBindingMigration) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func (*VirtualMachineOptions) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }
...
func (*VMIRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }
...
func (*MigrationRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }
...
func (*ExecRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }
...
func (*EmptyRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{19} }
...
func (*DomainResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }
...
func (*DomainStatsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{22} }
...
func (*GuestInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }
...
func (*GuestUserListResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{24} }
...
func (*GuestFilesystemsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }
...
func (*GuestPingRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }
...
func (*GuestPingResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
func (*FreezeRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }
...
func (*MemoryDumpRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (*SEVInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
func (*LaunchMeasurementResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }
...
func (*InjectLaunchSecretRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }
...
func (*DirtyRateStatsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{34} }
...
func (*ScreenshotResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{35} }
...
func (*BackupRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{36} }
...
func (*RedefineCheckpointRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{37} }
...
func (*RedefineCheckpointResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{38} }
...
func (*DomainStatsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{39} }
...
func (*DirtyRateRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{40} }
...
func (*AgentLoadRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{41} }
...
func (*AgentCpuStatsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{42} }
...
func (*AgentDiskStatsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{43} }
...
func (*AgentTimeRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{44} }
...
func (*AgentVcpusRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{45} }
...
func (*AgentMemoryBlockInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{46} }
...
func (*AgentUsersRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{47} }
...
func (*AgentOsInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{48} }
...
func (*AgentDisksRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{49} }
...
func (*AgentHostNameRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{50} }
...
func (*AgentTimezoneRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{51} }
...
func (*AgentNetworkRouteRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{52} }
...
func (*AgentNetworkInterfacesRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{53} }
...
func (*AgentMemoryBlocksRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{54} }
...
func (*VMStatsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{55} }
...
func (*VMStatsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{56} }
...
func init() {
	proto.RegisterType((*HibernationRequest)(nil), "kubevirt.cmd.v1.HibernationRequest")
	proto.RegisterType((*HibernationProtection)(nil), "kubevirt.cmd.v1.HibernationProtection")
	proto.RegisterType((*HibernationResponse)(nil), "kubevirt.cmd.v1.HibernationResponse")
	...
	proto.RegisterEnum("kubevirt.cmd.v1.HibernationAction", HibernationAction_name, HibernationAction_value)
}
...
type CmdClient interface {
	...
	HibernateVirtualMachine(ctx context.Context, in *HibernationRequest, opts ...grpc.CallOption) (*HibernationResponse, error)
}
...
func (c *cmdClient) HibernateVirtualMachine(ctx context.Context, in *HibernationRequest, opts ...grpc.CallOption) (*HibernationResponse, error) {
	out := new(HibernationResponse)
	err := grpc.Invoke(ctx, "/kubevirt.cmd.v1.Cmd/HibernateVirtualMachine", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CmdServer interface {
	...
	HibernateVirtualMachine(context.Context, *HibernationRequest) (*HibernationResponse, error)
}
...
func _Cmd_HibernateVirtualMachine_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HibernationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CmdServer).HibernateVirtualMachine(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kubevirt.cmd.v1.Cmd/HibernateVirtualMachine",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CmdServer).HibernateVirtualMachine(ctx, req.(*HibernationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Cmd_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HibernateVirtualMachine",
			Handler:    _Cmd_HibernateVirtualMachine_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
