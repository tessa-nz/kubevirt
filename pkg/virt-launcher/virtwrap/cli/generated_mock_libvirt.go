...
// Source: pkg/virt-launcher/virtwrap/cli/libvirt.go
//
// Generated by this command:
//
//	mockgen -source pkg/virt-launcher/virtwrap/cli/libvirt.go -imports libvirt=libvirt.org/go/libvirt -package=cli -destination=pkg/virt-launcher/virtwrap/cli/generated_mock_libvirt.go
//
...
// DomainRestoreFlags mocks base method.
func (m *MockConnection) DomainRestoreFlags(srcFile, xmlConf string, flags libvirt.DomainSaveRestoreFlags) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DomainRestoreFlags", srcFile, xmlConf, flags)
	ret0, _ := ret[0].(error)
	return ret0
}

// DomainRestoreFlags indicates an expected call of DomainRestoreFlags.
func (mr *MockConnectionMockRecorder) DomainRestoreFlags(srcFile, xmlConf, flags any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DomainRestoreFlags", reflect.TypeOf((*MockConnection)(nil).DomainRestoreFlags), srcFile, xmlConf, flags)
}

// DomainSaveImageDefineXML mocks base method.
func (m *MockConnection) DomainSaveImageDefineXML(file, xml string, flags libvirt.DomainSaveRestoreFlags) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DomainSaveImageDefineXML", file, xml, flags)
	ret0, _ := ret[0].(error)
	return ret0
}

// DomainSaveImageDefineXML indicates an expected call of DomainSaveImageDefineXML.
func (mr *MockConnectionMockRecorder) DomainSaveImageDefineXML(file, xml, flags any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DomainSaveImageDefineXML", reflect.TypeOf((*MockConnection)(nil).DomainSaveImageDefineXML), file, xml, flags)
}

// DomainSaveImageGetXMLDesc mocks base method.
func (m *MockConnection) DomainSaveImageGetXMLDesc(file string, flags libvirt.DomainSaveImageXMLFlags) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DomainSaveImageGetXMLDesc", file, flags)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DomainSaveImageGetXMLDesc indicates an expected call of DomainSaveImageGetXMLDesc.
func (mr *MockConnectionMockRecorder) DomainSaveImageGetXMLDesc(file, flags any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DomainSaveImageGetXMLDesc", reflect.TypeOf((*MockConnection)(nil).DomainSaveImageGetXMLDesc), file, flags)
}
...
// GetLibVersion mocks base method.
func (m *MockConnection) GetLibVersion() (uint32, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLibVersion")
	ret0, _ := ret[0].(uint32)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLibVersion indicates an expected call of GetLibVersion.
func (mr *MockConnectionMockRecorder) GetLibVersion() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLibVersion", reflect.TypeOf((*MockConnection)(nil).GetLibVersion))
}
...
// SaveFlags mocks base method.
func (m *MockVirDomain) SaveFlags(destFile, destXML string, flags libvirt.DomainSaveRestoreFlags) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveFlags", destFile, destXML, flags)
	ret0, _ := ret[0].(error)
	return ret0
}

// SaveFlags indicates an expected call of SaveFlags.
func (mr *MockVirDomainMockRecorder) SaveFlags(destFile, destXML, flags any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveFlags", reflect.TypeOf((*MockVirDomain)(nil).SaveFlags), destFile, destXML, flags)
}
