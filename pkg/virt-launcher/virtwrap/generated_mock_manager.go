...
// Source: pkg/virt-launcher/virtwrap/manager.go
//
// Generated by this command:
//
//	mockgen -source pkg/virt-launcher/virtwrap/manager.go -package=virtwrap -destination=pkg/virt-launcher/virtwrap/generated_mock_manager.go
//
