...
// Source: pkg/virt-handler/cmd-client/client.go
//
// Generated by this command:
//
//	mockgen -source pkg/virt-handler/cmd-client/client.go -package=cmdclient -destination=pkg/virt-handler/cmd-client/generated_mock_client.go
//
